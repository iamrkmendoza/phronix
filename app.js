...
/* LOGOUT */
function doLogout(){
  if(confirm('Logout? This will reset all your data.')){
    sessionStorage.removeItem('phronix_logged_in'); // ADD THIS
    Object.keys(localStorage).filter(k=>k.startsWith('phronix_')).forEach(k=>localStorage.removeItem(k));
    clearInterval(tmI);
